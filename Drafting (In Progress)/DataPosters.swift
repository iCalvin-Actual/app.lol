...
class DraftFetcher<D: SomeDraftable>: ModelBackedListFetcher<D.Draft> {
...
class MDDraftPoster<D: MDDraftable>: DraftPoster<D> {
    ...
    init(_ address: AddressName, draftItem: D.MDDraftItem, interface: OMGInterface, credential: APICredential, addressBook: AddressBook, db: Blackbird.Database) {
